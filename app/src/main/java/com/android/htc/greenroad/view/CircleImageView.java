package com.android.htc.greenroad.view;
...
public class CircleImageView extends android.support.v7.widget.AppCompatImageView {
	...
	public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		// 获取自定义属性值
		TypedArray array = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CircleImageView, defStyle, 0);
		...
		for (int i = 0; i < count; i++) {
			...
			case R.styleable.CircleImageView_borderRadius:
				// 获取圆角大小
				mBorderRadius = array.getDimensionPixelSize(R.styleable.CircleImageView_borderRadius, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, BORDER_RADIUS_DEFAULT, getResources().getDisplayMetrics()));
				break;
