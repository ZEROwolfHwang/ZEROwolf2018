...
import com.android.htc.greenroad.activity.MainActivity;
...
import com.android.htc.greenroad.bean.PathTitleBean;
...
import static com.android.htc.greenroad.activity.ShowActivity.mLite_id;
...
//    private static List<LocalMedia> mSelectList_huowu;
               ...
               int liteId  = TimeUtil.getTimeId();
                ...
                if (NetWorkManager.isnetworkConnected(sActivity)) {
                    if (GlobalManager.TYPE_DRAFT_ENTER_SHOW.equals(enterType)) {
                        postPictureAndJson(mSubmitTime, mLite_id);
                    } else {
                        postPictureAndJson(mSubmitTime, liteId);
                    }
                } else {
                    ...
                    builder.setPositiveButton("保存草稿", (dialog, which) -> {
                        save2Litepal(mSubmitTime, liteId, GlobalManager.TYPE_DRAFT_LITE, ACTION_SUBMIT, mShowType_submit);
                    });
                ...
                if (ACTION_SAVE.equals(action)) {
                    ...
                    int liteId = TimeUtil.getTimeId();
                    if (id == 0) {
                        save2Litepal(saveTime, liteId, GlobalManager.TYPE_DRAFT_LITE, ACTION_SAVE, showType);
                    } else {
                        save2Litepal(saveTime, liteId, GlobalManager.TYPE_DRAFT_LITE, ACTION_SAVE, showType);
     ...
     */
    private void save2Litepal(String current_time, int liteId, String lite_type, String action, String showType) {
//        int count = 0;
...
//                    SPUtils.cut_one(sActivity, SPUtils.MATH_DRAFT_LITE);
    ...
    private void postPictureAndJson(String postTime, int liteId) {
                    ...
                    RequestPicture.getInstance().postPicture(new Subscriber<HttpResultCode>() {
                        ...
                        public void onNext(HttpResultCode httpResultCode) {
                            ...
                            if (code == 200) {
                                ...
                                Logger.i("图片上传成功");
                                save2Litepal(mSubmitTime, liteId, GlobalManager.TYPE_SUBMIT_LITE, ACTION_SUBMIT, mShowType_submit);
                                Logger.i("走了提交保存的方法");
                            } else {
                                save2Litepal(mSubmitTime, liteId, GlobalManager.TYPE_DRAFT_LITE, ACTION_SUBMIT, mShowType_submit);
