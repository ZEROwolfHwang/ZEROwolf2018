package com.android.htc.greenroad.activity.license;
...
import com.android.htc.greenroad.activity.BaseActivity;
 ...
 * 上午10:55:28 修改备注：
 */
public class MemoryCameraActivity extends BaseActivity implements
        SurfaceHolder.Callback, Camera.PreviewCallback {
    private static final String TYPE_ENTER_SHOW = "type_enter_show";
    private static final String CAR_GOODS = "car_goods";
    ...
    public static void actionStart(AppCompatActivity activity, DetailsFragment fragment, boolean isCamera) {
        Intent intent = new Intent(activity, MemoryCameraActivity.class);
        intent.putExtra("camera", isCamera);
//        intent.putExtra(TYPE_ENTER_SHOW, enterType);
//        intent.putExtra(CAR_GOODS, carGoods);
        fragment.startActivityForResult(intent,ShowActivity.RESULT_CODE_LICENSE);
...
//                WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
    ...
    private void getIntentData() {
        ...
        mEnterType = getIntent().getStringExtra(TYPE_ENTER_SHOW);
        mCarGoods = getIntent().getStringExtra(CAR_GOODS);
...
//                finish();
    ...
    //返回车辆采集界面
    private void backToSure(String number) {
        Logger.i(number);
//        SerializableMain2Sure main2Sure = new SerializableMain2Sure();
//        main2Sure.setCarNumber_I(number);
//        main2Sure.setGoods_I(mCarGoods);
//        ShowActivity.actionStart(this, ShowActivity.ACTION_MEMORY_ENTER_SHOW, mEnterType);
//        MemoryCameraActivity.this.finish();
        Intent intent = new Intent();
        intent.putExtra(ShowActivity.LICENSE_NUMBER, number);
        MemoryCameraActivity.this.setResult(ShowActivity.RESULT_CODE_LICENSE, intent);
        MemoryCameraActivity.this.finish();
