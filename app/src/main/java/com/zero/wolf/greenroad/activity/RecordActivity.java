...
import com.zero.wolf.greenroad.tools.VideoFileUtils;
...
import static com.zero.wolf.greenroad.activity.CommonUtils.SIZE_1;
import static com.zero.wolf.greenroad.activity.CommonUtils.SIZE_2;
import static com.zero.wolf.greenroad.activity.CommonUtils.getScreenHeight;
import static com.zero.wolf.greenroad.activity.CommonUtils.getScreenWidth;
...
public class RecordActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private boolean startRecord() {
        ...
        try {
            ...
            recorder = null;
            showCameraPermission();
            VideoFileUtils.deleteFile(videoFile.getPath());
            return false;
        }
        return true;
    ...
    private void endRecord() {
        ...
        intent.putExtra(ShootVideoActivity.DATA, videoFile.getAbsolutePath());
    ...
    public String videoDir() {
        File sampleDir = new File(VideoFileUtils.getAppPath());
        if (!sampleDir.exists()) {
            sampleDir.mkdirs();
        }
