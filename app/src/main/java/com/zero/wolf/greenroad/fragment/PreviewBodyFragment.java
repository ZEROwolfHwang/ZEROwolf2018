...
public class PreviewBodyFragment extends Fragment {

    private static PreviewBodyFragment sFragment;
    ...
    public static PreviewBodyFragment newInstance(SerializablePreview previewDetail) {
        if (sFragment == null) {
            sFragment = new PreviewBodyFragment();
        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Bitmap bitmap = BitmapFactory.decodeFile(mPreviewDetail1.getPhotoPath2());
        if (bitmap != null) {
            mPreviewItemImgPhoto.setImageBitmap(bitmap);
        }
        mTextViewPreviewDetail.setText(getString(R.string.tv_car_body));
        return view;
    }
