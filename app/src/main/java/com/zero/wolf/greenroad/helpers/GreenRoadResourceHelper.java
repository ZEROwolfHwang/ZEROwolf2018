package com.zero.wolf.greenroad.helpers;
...
public class GreenRoadResourceHelper {
    ...
    private static GreenRoadResourceHelper mInstance;  //  静态实例对象
    private Context mContext;  // 上下文环境

    private GreenRoadResourceHelper(Context context) {
        setContext(context);
        // 私有化构造方法
    }
     ...
     * */
    public static GreenRoadResourceHelper getInstance(@NonNull Context context) {
        if (mInstance == null) {
            synchronized (GreenRoadResourceHelper.class) {
                if (mInstance == null) mInstance = new GreenRoadResourceHelper(context);
            }
        } else {
