...
# and specify the fully qualified class mScientificname to the JavaScript interface
# class:
#-keepclassmembers class fqcn.of.javascript.interface.for.webview {
#   public *;
#}

# Uncomment this to preserve the line mAlias information for
# debugging stack traces.
#-keepattributes SourceFile,LineNumberTable

# If you keep the line mAlias information, uncomment this to
# hide the original source file mScientificname.
